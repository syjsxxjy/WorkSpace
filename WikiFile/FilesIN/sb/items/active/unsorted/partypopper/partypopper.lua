...
function init()
  -- world.logInfo("Initializing metagun")
...
function uninit()
  -- world.logInfo("Uninitializing metagun")
end

function update(dt, fireMode, shiftHeld)
  -- world.logInfo("Updating metagun with fireMode %s and shiftHeld %s", fireMode, shiftHeld)
...
function activate(fireMode, shiftHeld)
  -- world.logInfo("Activating metagun with fireMode %s and shiftHeld %s", fireMode, shiftHeld)
